...
if __name__ == '__main__':
    model_path = r'D:\github_code\RTDETR-20251219\RTDETR-main\runs\train\213+129+339-ABOshipDataset\weights\best.pt'
    model = RTDETR(model_path)  # 选择训练好的权重路径
    result = model.val(data=r"D:\dldata\ABOshipsDataset\yolo_format811\data_filtered.yaml",
                       split='test',  # split可以选择train、val、test 根据自己的数据集情况来选择.
                       imgsz=640,
                       batch=1,
                       #   save_json=True, # if you need to cal coco metrice
                       project='runs/val',
                       name='213+129+339-ABOshipDataset',
                       )
